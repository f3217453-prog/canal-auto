"""
MindBlown - Pipeline Top 10 Viral Moments - Version 1.0

Top 10 de momentos virales, cosas imposibles, records increibles,
fails epicos, fenomenos naturales, animales raros, etc.
...
# Todas con material gratuito de Pexels
CATEGORIAS = {
    "impossible_moments": {
        "temas": [
            "things that should be physically impossible but actually happened",
            "moments caught on camera that defied the laws of physics",
            "most incredible coincidences ever recorded on video",
            "things that happened once in a billion years",
            "moments so rare scientists still cannot explain them",
            "most insane weather phenomena ever captured on camera",
            "natural events so extreme they broke every record",
        ],
        "consultas_broll": [
    ...
    "animal_moments": {
        "temas": [
            "most incredible animal moments ever caught on camera",
            "animals doing things humans thought were impossible",
            "most surprising animal behaviors scientists discovered",
            "rarest animals ever filmed in the wild",
            "most dangerous animal encounters people somehow survived",
            "animals with abilities that seem like superpowers",
            "most intelligent animal behaviors ever recorded",
        ],
        "consultas_broll": [
    ...
    "human_achievements": {
        "temas": [
            "most insane world records broken in the last year",
            "things humans built that seem physically impossible",
            "most extreme sports moments ever captured on camera",
            "people who did things everyone said were impossible",
            "most daring stunts ever performed by humans",
            "engineering achievements that changed the world forever",
            "moments athletes did something nobody had ever done before",
        ],
        "consultas_broll": [
    ...
    "viral_moments": {
        "temas": [
            "most incredible moments caught on camera this year",
            "things caught on security cameras nobody can explain",
            "most satisfying moments ever filmed",
            "things that went so wrong they became legendary",
            "luckiest moments ever captured on camera",
            "most perfectly timed photos and videos ever taken",
            "moments that made the entire internet stop scrolling",
        ],
        "consultas_broll": [
            "slow motion water splash", "satisfying domino effect",
            "perfect timing sports", "lucky escape dramatic",
            "fireworks display night", "crowd reaction event",
            "slow motion ball sport", "timelapse city night",
            "drone aerial city", "sunset dramatic sky",
            "ocean waves slow motion", "rain drops slow motion",
        ],
        "color_sub": "#FF4444",
        "emoji_titulo": "🔥",
    },
...
You create top 10 countdowns about mind-blowing, impossible, and incredible moments.
...
- Must use ONE of these proven viral patterns:
  * IMPOSSIBILITY: "This should not be physically possible."
  * SHOCK: "Number 1 on this list broke every record."
  * CURIOSITY: "Scientists still cannot explain number 3."
  * PERSONAL: "You have never seen anything like number 1."
- Must stop someone mid-scroll instantly

COUNTDOWN RULES:
- Start with hook IMMEDIATELY — no intro, no filler
- Number from 10 down to 1
- Each entry: 1-2 punchy sentences with ONE specific mind-blowing detail
...
- Examples: "Top 10 Things That Shouldn't Exist" / "Top 10 Moments Physics Forgot"
...
"guion": "...(100-120 words STRICT, countdown 10 to 1)...",
"escenas": ["pexels search phrase 1", "pexels search phrase 2", "pexels search phrase 3"],
"titulo": "...(under 40 chars + {emoji} + #Shorts)...",
"tags": ["mindblown", "top10", "viral", "shorts", "amazing", "incredible", "facts", "unbelievable", "mindblowing", "wow"]
}}"""
...
def armar_video(clips_por_escena, pool_generico, imagenes_ia, audio_path,
    ...
    PALABRAS_CLAVE = {
        ...
        "survived", "discovered", "captured", "filmed",
    }
...
def main():
    ...
    hook_texto = contenido.get("hook", "You have never seen anything like this.")
    ...
    titulo = contenido.get("titulo", "Top 10 Things That Shouldn't Exist 🤯 #Shorts")
    HASHTAGS = ["#shorts", "#top10", "#viral", "#mindblown", "#amazing",
                "#incredible", "#unbelievable", "#facts", "#wow", "#mindblowing"]
    tags = list(dict.fromkeys(
        contenido.get("tags", []) + [
            "mindblown", "top10", "viral", "shorts", "amazing",
            "incredible", "facts", "unbelievable", "mindblowing",
            "wow", "satisfying", "nature", "science", "records",
        ]
    ))
    descripcion = (
        f"{contenido['guion']}\n\n"
        f"🔥 Subscribe to MindBlown for daily mind-blowing moments.\n\n"
        f"{' '.join(HASHTAGS)}"
    )
